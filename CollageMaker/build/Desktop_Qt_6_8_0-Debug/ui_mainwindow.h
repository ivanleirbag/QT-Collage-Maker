...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        saveDrawing->setGeometry(QRect(30, 270, 101, 23));
        selectImages = new QPushButton(groupBox);
        selectImages->setObjectName("selectImages");
        selectImages->setGeometry(QRect(30, 300, 101, 23));
        ...
        label_3->setGeometry(QRect(10, 270, 16, 20));
        label_4 = new QLabel(groupBox);
        label_4->setObjectName("label_4");
        label_4->setGeometry(QRect(10, 300, 16, 20));
